...
install:
	...
	install -Dm0755 Images/Icon.svg $(DESTDIR)/usr/share/icons/hicolor/scalable/apps/omp.svg
	install -Dm0755 Images/OMP_Icon_16.png $(DESTDIR)/usr/share/icons/hicolor/16x16/apps/omp.png
	install -Dm0755 Images/OMP_Icon_32.png $(DESTDIR)/usr/share/icons/hicolor/32x32/apps/omp.png
	install -Dm0755 Images/OMP_Icon_48.png $(DESTDIR)/usr/share/icons/hicolor/48x48/apps/omp.png
	install -Dm0755 Images/OMP_Icon_64.png $(DESTDIR)/usr/share/icons/hicolor/64x64/apps/omp.png
	install -Dm0755 Images/OMP_Icon_128.png $(DESTDIR)/usr/share/icons/hicolor/128x128/apps/omp.png
