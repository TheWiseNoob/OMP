...
class TimeConversion
{
  ...
  public:
    ...
    std::string* Nanoseconds_To_Time_Format(long long temp_nanoseconds);

    long long Time_Format_To_Nano_Seconds(const std::string& time,
                                          bool milliseconds = false);

    std::string* Seconds_To_Time_Format(int temp_seconds);

    int Time_Format_To_Seconds(std::string& time);
